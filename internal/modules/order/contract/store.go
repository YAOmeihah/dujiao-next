...
type Store interface {
	...
	GetByIDAndGuest(id uint, phone, password string) (*orderdomain.Order, error)
	GetByOrderNoAndGuest(orderNo, phone, password string) (*orderdomain.Order, error)
	GetAnyByOrderNoAndGuest(orderNo, phone, password string) (*orderdomain.Order, error)
	...
	GetByIDAndGuestScoped(id uint, phone, password string, scope TenantScope) (*orderdomain.Order, error)
	GetByOrderNoAndGuestScoped(orderNo, phone, password string, scope TenantScope) (*orderdomain.Order, error)
	GetAnyByOrderNoAndGuestScoped(orderNo, phone, password string, scope TenantScope) (*orderdomain.Order, error)
	...
	ListByGuest(phone, password string, page, pageSize int) ([]orderdomain.Order, int64, error)
	ListByGuestScoped(phone, password string, page, pageSize int, scope TenantScope) ([]orderdomain.Order, int64, error)
