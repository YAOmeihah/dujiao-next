...
import (
	...
	addressloader "github.com/dujiao-next/internal/modules/addressdivision/infrastructure/fileloader"
...
func NewContainer(cfg *config.Config) (*Container, error) {
	...
	dataset, err := addressloader.LoadDataset()
	if err != nil {
		return nil, fmt.Errorf("load address divisions: %w", err)
	}
	c.AddressDivisionRepo = addressstore.New(dataset)
...
func newPaymentProviderRegistry() *paymentprovider.Registry {
	...
	registry.Register(constants.PaymentProviderVpay, "", vpayadapter.NewVpayAdapter())
	return registry
}
