...
import (
	...
	addresshttp "github.com/dujiao-next/internal/modules/addressdivision/transport/http"
...
func registerStorefrontRoutes(
	...
	public := storefront.Group("/public")
	{
		...
		addresshttp.RegisterPublicRoutes(public, addresshttp.NewHandler(c.AddressService))
