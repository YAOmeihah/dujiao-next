...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.risk_phone_blacklisted":                   "该手机号已被限制下单，请联系客服",
		...
		"error.guest_phone_required":                     "游客手机号不能为空",
		...
		"error.shipping_address_required":                "请填写完整收货地址",
		"error.shipping_address_invalid":                 "收货地址格式不正确",
		...
		"email.order_status.guest_tip":                   "游客订单可使用下单手机号与订单密码在网站查询订单详情。",
	...
	LocaleTW: {
		...
		"error.risk_phone_blacklisted":                   "該手機號已被限制下單，請聯繫客服",
		...
		"error.guest_phone_required":                     "遊客手機號不能為空",
		...
		"error.shipping_address_required":                "請填寫完整收貨地址",
		"error.shipping_address_invalid":                 "收貨地址格式不正確",
		...
		"email.order_status.guest_tip":                   "遊客訂單可使用下單手機號與訂單密碼在網站查詢訂單詳情。",
	...
	LocaleEN: {
		...
		"error.phone_invalid":                            "Invalid phone format",
		...
		"error.risk_phone_blacklisted":                   "This phone number has been restricted from placing orders, please contact support",
		...
		"error.guest_phone_required":                     "Guest phone is required",
		...
		"error.shipping_address_required":                "Please complete the shipping address",
		"error.shipping_address_invalid":                 "Shipping address format is invalid",
		...
		"email.order_status.guest_tip":                   "Guest orders can be queried on the site using the checkout phone number and order password.",
