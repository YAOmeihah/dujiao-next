    ...
    <div class="container mx-auto px-4">
      ...
      <div class="rounded-2xl border bg-card p-6 shadow-sm mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Input v-model="phone" type="tel" class="h-11" :placeholder="t('guestOrders.phonePlaceholder')" />
...
const {
  savedAuth, phone, orderPassword, orderNo, loading, error, orders, pagination,
