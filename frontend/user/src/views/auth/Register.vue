...
const {
  ...
  captchaPayload, turnstileToken, capToken, imageCaptchaRef, turnstileRef, capRef,
  captchaProvider, sendCodeCaptchaEnabled, turnstileSiteKey, capEndpoint, capSiteKey,
