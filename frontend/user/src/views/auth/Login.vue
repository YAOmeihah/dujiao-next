...
const {
  ...
  loginCaptchaEnabled, captchaProvider, captchaPayload, turnstileToken, capToken, turnstileSiteKey, capEndpoint, capSiteKey,
  imageCaptchaRef, turnstileRef, capRef, handleCaptchaConfigStale,
